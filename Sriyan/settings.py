"""
Django settings for Sriyan project.
...
SECRET_KEY = 'django-insecure-oslbm#rkuccnyz!)54+^@efo=s8#g6%%3mdanpnbs1i*&nxf4@'
...
WSGI_APPLICATION = 'Sriyan.wsgi.application'
